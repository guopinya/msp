...
(function () {
    ...
    $("#file_1").change(function (e) {
        pass = true;
        c.width = document.documentElement.clientWidth - 100;
        ...
        if (files.size > maxSize) {
            ...
            EXIF.getData(files, function () {
                ...
                // alert(EXIF.getTag(files, 'Orientation'));
                        ...
                        if (Orientation != "" && Orientation != 1) {
                            ...
                            switch (Orientation) {
                                case 6://需要顺时针（向左）90度旋转
                                    ...
                                    // c.width = document.documentElement.clientHeight - 60;
                                    // cxt.style.transform = 'rotate('+90+'deg)';
                                    // c.cxt.rotate(90);
                                    // canvas.ctx.rotate(deg);
                                    // rotateImg(this,'left',c);
                                    rotateImg('left', cxt);
