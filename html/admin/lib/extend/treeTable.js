...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function (exports) {
    ...
    var $ = layui.$
        ...
        //字符常量
        , MOD_NAME = 'treeTable', ELEM = '.layui-table', THIS = 'layui-this', SHOW = 'layui-show', HIDE = 'layui-hide',
    ...
    Class.prototype.treeConvertShowName = function (o) {
        ...
        var temhtml = '<div style="float: left;height: 28px;line-height: 28px;padding-left: ' +
            ...
            + function () {//图标或占位符
                var temTreeHtml = '';
                if (isTreeNode) temTreeHtml = '<i class="layui-icon layui-tree-head" style="cursor: pointer;">&#xe625;</i> ';
                return temTreeHtml;
            }()
            + '</div>';
        return temhtml;
    ...
    Class.prototype.fullSize = function () {
        var that = this
            , options = that.config
            , height = options.height, bodyHeight = 'auto';

        height = that.getParentDivHeight(options.id) - that.fullHeightGap;
        if (height < 135) height = 'auto';
