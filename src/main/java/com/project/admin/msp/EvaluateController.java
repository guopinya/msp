...
@RestController("evaluateController_admin")
...
public class EvaluateController extends BaseController {
     ...
     */
    @PutMapping
    public JsonResult modifyEvaluate(Evaluate evaluate, List<MultipartFile> bannerFiles) {
        evaluate.setEvaluateBanner(assembleFiles(upload(bannerFiles), evaluate.getEvaluateBanner()));
