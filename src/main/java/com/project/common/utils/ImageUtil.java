 ...
 * 图片压缩工具类
 *
 * @author 从这里抄来的：https://www.cnblogs.com/zuidongfeng/p/9853335.html
...
public class ImageUtil {
     ...
     * @throws IOException
     */
    public static void createBigPicture(Integer width, Integer height, String pathname, String file) throws IOException {
        Thumbnails.of(file)
                // 图片缩放的高度宽度
                .size(width, height)
                // 缩略图保存目录,该目录需存在，否则报错
     ...
     * @param width     图片缩放宽度
     * @param height    图片缩放高度
     * @param sourceImg 图片数据
     * @param
     * @throws IOException
     */
    public static BufferedImage createNewPicture(Integer width, Integer height, BufferedImage sourceImg) throws IOException {
     ...
     * @throws IOException
     */
    public static void createSmallPicture(Integer width, Integer height, String pathname, String file) throws IOException {
        Thumbnails.of(file)
                // 图片缩放的高度宽度
                .size(width, height)
                // 缩略图保存目录,该目录需存在，否则报错
                .toFiles(new File(pathname), Rename.SUFFIX_DOT_THUMBNAIL);
    }
    ...
    public static boolean isImage(String extension) {
        ...
        String[] imageExtension = new String[]{"jpeg", "jpg"};
     ...
     * @return
     */
    public static boolean isImageOthers(String extension) {
        //String[] imageExtension = new String[]{"jpeg", "jpg", "gif", "bmp", "png"};
        String[] imageExtension = new String[]{"gif", "bmp", "png"};
